...
//CONSTANTES RELACIONALES
    public static final String MARCACION_TABLA = "marcaciones_" + Globals.MES_ABREV[Lector.getMES() - 1] + "_" + Lector.getANIO();
    ...
    public Marcacion(String id, int legajo, String agente, int tarjeta, Fecha fecha, Hora hora, int reloj, int codigo, Fecha fechaProceso, int tipo) {
        this.id = id;
        this.legajo = legajo;
        this.agente = agente;
    ...
    public Marcacion(int legajo, String agente, int tarjeta, Fecha fecha, Hora hora, int reloj, int codigo, Fecha fechaProceso) {
        this.legajo = legajo;
        this.agente = agente;
        this.tarjeta = tarjeta;
        this.fecha = fecha;
    ...
    public Marcacion setTipo(int tipo) {
        this.tipo = tipo;
        return this;
    }
...
// GUARDAR EN LA BASE DE DATOS
    ...
    public String getConsultaInsert(int mes, int anio) {
        
        String tabla = "marcaciones_" + Globals.MES_ABREV[mes - 1] + "_" + anio;
    ...
    public Marcacion actualizarBD(String usuario, String clave) throws Exception {
        AdaptadorMySQL datos = new AdaptadorMySQL(usuario, clave);
...
// LEER DE LA BASE DE DATOS
    public static synchronized Marcacion[] leerBD(String restriccion, String usuario, String clave) {

        Marcacion marcacions[];
        java.util.ArrayList<Marcacion> vectorMarcacions = new java.util.ArrayList<>();
        ...
        try {
            ...
            while (datos.resultados.next()) {
                vectorMarcacions.add(new Marcacion(datos.resultados.getString(CAMPO_ID_TABLA),
            ...
            marcacions = new Marcacion[vectorMarcacions.size()];

            for (int i = 0; i < marcacions.length; i++) {
                marcacions[i] = ((Marcacion) vectorMarcacions.get(i));
            }
     ...
     * validacion
     */
    public static synchronized Marcacion[] leerBD(String usuario, String clave) throws Exception {
    ...
    public static String seleccionarMarcacion(String marcs, String usuario, String clave) {
        ...
        cadena += "<OPTION VALUE=\"\"> ---\n";
        Marcacion[] marcacions = leerBD("1=1 ORDER BY LEGAJO", usuario, clave);
    ...
    public static String seleccionarMarcacion(String marcs, Marcacion[] marcacions) {
        String cadena = "<SELECT NAME=\"" + marcs + "\">\n";
    ...
    public static Marcacion leerMarcaPorId(String id, String usuario, String clave) {
    ...
    public static void crearMarcaciones() throws Exception {
        ...
        for (int i = 0; i < diasHorarios.size(); i++) {
            ...
            Marcacion marcaEntrada = new Marcacion(legajo, nombre, legajo, new Fecha(temp[0] + "/10/2020"),
                    new Hora(temp[1]), 1, 20, new Fecha()).setTipo(2);

            Marcacion marcaSalida = new Marcacion(legajo, nombre, legajo, new Fecha(temp[0] + "/10/2020"),
